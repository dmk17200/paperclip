...
class PiecesControllerTest < ActionController::TestCase
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post :create, piece: { element_id: @piece.element_id, outfit_id: @piece.outfit_id }
    end
  ...
  test "should update piece" do
    put :update, id: @piece, piece: { element_id: @piece.element_id, outfit_id: @piece.outfit_id }
    assert_redirected_to piece_path(assigns(:piece))
  end
